...
static weapdef_t nqWeapons[] =
{
	...
	{ "Air Strike",		WT_HEAVY,		WA_NO_AMMO					},	// 21
	{ "KAR98",		WT_SMG,			WA_USER_DEFINED | WA_BLOCK_FIRE			},	// 22
	{ "M1 Garand",		WT_RIFLE,		WA_USER_DEFINED | WA_BLOCK_FIRE			},	// 23
	{ "Garand",		WT_RIFLE,		WA_USER_DEFINED | WA_BLOCK_FIRE | WA_UNSCOPED	},	// 24
	{ "Landmine",		WT_EXPLOSIVE,		WA_ONLY_CLIP					},	// 25
	{ "Satchel",		WT_EXPLOSIVE,		WA_NO_AMMO					},	// 26
	{ "Detonator",		WT_NONE,		WA_NO_AMMO | WA_SATCHEL				},	// 27
	{ "Smoke Grenade",	WT_EXPLOSIVE,		WA_NO_AMMO					},	// 28
	{ "Tripmine",		WT_EXPLOSIVE,		WA_NONE						},	// 29
	{ "K-43",		WT_RIFLE,		WA_USER_DEFINED | WA_BLOCK_FIRE | WA_UNSCOPED	},	// 30
	{ "FG-42",		WT_RIFLE,		WA_USER_DEFINED | WA_BLOCK_FIRE | WA_UNSCOPED	},	// 31
	{ "MG-42",		WT_MG,			WA_USER_DEFINED | WA_BLOCK_FIRE | WA_OVERHEAT	},	// 32
	{ "Mortar",		WT_HEAVY,		WA_NONE						},	// 33
	{ "Akimbo Colt",	WT_NONE,		WA_USER_DEFINED | WA_BLOCK_FIRE | WA_AKIMBO, 7	},	// 34
	{ "Akimbo Lugers",	WT_PISTOL,		WA_USER_DEFINED | WA_BLOCK_FIRE | WA_AKIMBO, 7	},	// 35
	{ "Rifle Grenade",	WT_EXPLOSIVE,		WA_RIFLE_GRENADE				},	// 36 axis
	{ "Rifle Grenade",	WT_EXPLOSIVE,		WA_RIFLE_GRENADE				},	// 37 allies
	{ "Silenced Colt",	WT_PISTOL,		WA_USER_DEFINED | WA_BLOCK_FIRE			},	// 38
	{ "Garand (Scoped)",	WT_SNIPER,		WA_USER_DEFINED | WA_BLOCK_FIRE | WA_SCOPED	},	// 39 scoped
	{ "K-43 (Scoped)",	WT_SNIPER,		WA_USER_DEFINED | WA_BLOCK_FIRE | WA_SCOPED	},	// 40 scoped
	{ "FG-42",		WT_SNIPER,		WA_USER_DEFINED | WA_BLOCK_FIRE | WA_SCOPED	},	// 41 scoped
	{ "Mortar Set",		WT_HEAVY,		WA_MORTAR					},	// 42
	{ "???????????",	WT_PISTOL,		WA_USER_DEFINED | WA_BLOCK_FIRE | WA_AKIMBO, 2	},	// 43
	{ "Adrenaline",		WT_NONE,		WA_NONE						},	// 44
	{ "Silenced Colts",	WT_PISTOL,		WA_USER_DEFINED | WA_BLOCK_FIRE | WA_AKIMBO, 7	},	// 45
	{ "Silenced Lugers",	WT_PISTOL,		WA_USER_DEFINED | WA_BLOCK_FIRE | WA_AKIMBO, 2	},	// 46
	{ "Shotgun",		WT_SHOTGUN,		WA_USER_DEFINED | WA_BLOCK_FIRE			},	// 47
	{ "Knife",		WT_KNIFE,		WA_USER_DEFINED	| WA_NO_AMMO			},	// 48
	{ "Browning",		WT_MG,			WA_USER_DEFINED | WA_BLOCK_FIRE | WA_OVERHEAT	},	// 49
	{ "Browning Set",	WT_MG,			WA_USER_DEFINED | WA_BLOCK_FIRE | WA_OVERHEAT	},	// 50
	{ "BAR",		WT_SMG,			WA_USER_DEFINED | WA_BLOCK_FIRE			},	// 51
	{ "BAR Set",		WT_SMG,			WA_USER_DEFINED | WA_BLOCK_FIRE			},	// 52
	{ "STG 44",		WT_SMG,			WA_USER_DEFINED | WA_BLOCK_FIRE			},	// 53
	{ "Mobile MG-42",	WT_MG,			WA_USER_DEFINED | WA_BLOCK_FIRE | WA_OVERHEAT	},	// 54
	{ "Bazooka",		WT_HEAVY,		WA_ONLY_CLIP					},	// 55
	{ "MP-34",		WT_SMG,			WA_USER_DEFINED | WA_BLOCK_FIRE	| WA_OVERHEAT	},	// 56
	{ "Moerser",		WT_HEAVY,		WA_NONE						},	// 57
	{ "Moerser Set",	WT_HEAVY,		WA_NONE						},	// 58
	{ "Venom",		WT_MG,			WA_USER_DEFINED | WA_BLOCK_FIRE | WA_OVERHEAT	},	// 59
	{ "Sten MKII",		WT_SMG,			WA_USER_DEFINED | WA_BLOCK_FIRE			},	// 60
	{ "Firebolt",		WT_NONE,		WA_NONE						},	// 61
	{ "Poison Syringe",	WT_NONE,		WA_NONE						},	// 62
};
