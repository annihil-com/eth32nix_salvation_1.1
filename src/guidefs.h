	...
	******************************************************************* **/
	{
		...
		16,				// num controls
		{
			...
			{ CTRL_CHECKBOX,	"Third Person",		5,		112,		140,	8,		(int)&eth32.settings.thirdPerson },
			{ CTRL_CHECKBOX,	"Damage Feedback",	5,		125,		140,	8,		(int)&eth32.settings.dmgFeedback },
			{ CTRL_CHECKBOX,	"Auto Vote",		5,		138,		140,	8,		(int)&eth32.settings.autoVote },
			{ CTRL_CHECKBOX,	"Auto Complaint",	5,		151,		140,	8,		(int)&eth32.settings.autoComplaint },
			{ CTRL_CHECKBOX,	"Anti Teamkill",	5,		164,		140,	8,		(int)&eth32.settings.antiTk },
			{ CTRL_CHECKBOX,	"Spoof OS",		5,		177,		140,	8,		(int)&eth32.settings.etproOs },
			{ CTRL_CHECKBOX,	"Timenudge Hack",	5,		190,		140,	8,		(int)&eth32.settings.nudgeHack },
			{ CTRL_CHECKBOX,	"Picmip Hack",		5,		203,		140,	8,		(int)&eth32.settings.r_picmip },
			{ CTRL_INTSLIDER,	"Picmip Value",		5,		216,		140,	20, 0, 20,	(int)&eth32.settings.r_picmipVal },
		},
	},
