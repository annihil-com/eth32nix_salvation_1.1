...
// Reversed from NQ 1.2.9_B5
typedef enum nqWeaponStats_s
{
	NQWS_KNIFE,				// 0
	NQWS_LUGER,				// 1
	NQWS_COLT,				// 2
	...
	NQWS_THOMPSON,				// 4
	NQWS_STEN,				// 5
	NQWS_FG42,				// 6	-- Also includes WS_BAR (allies version of fg42)
	NQWS_PANZERFAUST,			// 7
	NQWS_FLAMETHROWER,			// 8
	NQWS_GRENADE,				// 9	-- Includes axis and allies grenade types
	NQWS_MORTAR,				// 10
	NQWS_DYNAMITE,				// 11
	NQWS_AIRSTRIKE,				// 12	-- Lt. smoke grenade attack
	NQWS_ARTILLERY,				// 13	-- Lt. binocular attack
	NQWS_SATCHEL,				// 14	-- Medic syringe uses/successes
	NQWS_GRENADELAUNCHER,			// 15
	NQWS_LANDMINE,				// 16
	NQWS_MG42,				// 17
	NQWS_GARAND,				// 18 // Gordon: (carbine and garand)
	NQWS_K43,				// 19 // Gordon: (kar98 and k43)
	NQWS_SHOTGUN,				// 20 (jet Pilot - Shotgun)
	NQWS_BROWNING,				// 21 (jet Pilot - Mobile Browning)
	NQWS_STG44,				// 22 (jet Pilot - German StG44 Assault Rifle)
	NQWS_BAR,				// 23 (jet Pilot - BAR )
	NQWS_BAZOOKA,				// 24 (jet Pilot - Bazoka )
	NQWS_MP34,				// 25 (jet Pilot - Solothurn S1-100 )
	NQWS_VENOM,				// 26
	NQWS_POISON,				// ??
	NQWS_MAX
} nqWeaponStats_t;
